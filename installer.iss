...
[Registry]
Root: HKCU; Subkey: "Software\Classes\.cleanroom-receipt"; ValueType: string; ValueName: ""; ValueData: "CleanroomReceipt"; Flags: uninsdeletevalue
Root: HKCU; Subkey: "Software\Classes\.cleanroom-receipt"; ValueType: string; ValueName: "Content Type"; ValueData: "application/x-cleanroom-receipt"; Flags: uninsdeletevalue
